...
class InstallationState:
    ...
    def get_server_status(self) -> Dict[str, Any]:
        ...
        status = {"engine": "unknown", "services": [], "urls": [], "running": False}
                ...
                for service_name, service_config in services.items():
                    ...
                    for port_mapping in ports:
                        if isinstance(port_mapping, str) and ":" in port_mapping:
                            ...
                            status["urls"].append(
                                {"service": service_name, "url": url, "port": host_port}
                            )
    ...
    def run_quick_setup(self) -> bool:
        ...
        try:
            ...
            workspace = manager.create_workspace(
                "demo-workspace", "Demo MCP workspace with sample services"
            )
            ...
            workspace.services = {
                "demo-web": {
                    ...
                    "labels": ["mcp-hub.service=demo", "mcp-hub.type=web"],
                }
            }
